...
Zarafa.mail.ui.MailGrid = Ext.extend(Zarafa.common.ui.grid.MapiMessageGrid, {
	...
	viewConfigGetRowClass : function(record, rowIndex, rowParams, store)
	{
		...
		if (this.enableRowBody) {
			...
			rowParams.body += String.format('<div class="icon_horizontal_ellipsis grid_compact grid_compact_left grid_compact_subject_cell {0}">{1}</div>', meta.css, value);
			rowParams.body += String.format('<div class="x-grid3-cell-inner x-grid3-col-3 x-unselectable {0}">{1}</div>', meta.css, dateValue);
